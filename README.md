...
![version](https://img.shields.io/badge/version-1.3.0-265496)
...
- **Collect** jobs from free public sources through a pluggable `JobSource` interface (LinkedIn public listings first), rate limited and failure tolerant.
